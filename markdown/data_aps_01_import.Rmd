...
```{r}
path <- "/Volumes/sph_research/Detect/APS In-Home Intakes of Clients Age 65 or Over in Denton Johnson or Tarrant Counties.xlsx"
```
...
```{r}
vars <- quos(full_name, first_name, middle_name, last_name, address, city)
...
```{r}
feather::write_feather(client_data, "/Volumes/sph_research/Detect/client_data.feather")
feather::write_feather(allegations, "/Volumes/sph_research/Detect/allegations.feather")
feather::write_feather(closure, "/Volumes/sph_research/Detect/closure.feather")
feather::write_feather(disposition, "/Volumes/sph_research/Detect/disposition.feather")
```
