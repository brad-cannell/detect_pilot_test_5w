...
In this file, we do general cleaning of the raw MedStar data.
...
```{r}
# medstar_detect_deidentified <- select(medstar_detect, age:adls61, detect_data)
# write_feather(medstar_detect_deidentified, "../data/medstar_detect_deidentified.feather")
```
