...
In this file, we import the raw data files received from MedStar and do some basic data checks. Additionally, we renumber the incident call numbers and incident PCR numbers so that they cannot be linked back to MedStar's database. This is part of deidentifying the data.
...
3. [Deidentifify incident call numbers and incident PCR numbers](deidentify)     
4. [Add incident PCR number to MedStar DETECT data](#add-pcr)    
5. [Merge the screening data with the demographics and health data](#merge)    
6. [Create a unique person identifier](#person)     
7. [Save data for merge with APS data](#save)    
...
* Incident PCR number 977 (2 rows) is a practice chart and should be dropped from the data.
