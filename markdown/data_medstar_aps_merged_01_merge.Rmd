...
medstar_nested <- medstar_complete %>% 
  ...
  nest(-incident_pcr_number, -date_entered, -first_name, -last_name, -starts_with("birth"), 
       .key = "medstar_nested")
```
...
That means that one PCR is duplicated. Why?
...
Can we widen these out to tow rows to make it easier to compare differences?
