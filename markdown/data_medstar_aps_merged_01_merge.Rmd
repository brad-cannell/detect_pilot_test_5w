...
vars_to_keep <- quos(incident_call_number, incident_pcr_number, case_num, date_entered, 
                     intake_start, first_name, last_name, age, address_num, address_street, 
...
```{r}
about_data(medstar_aps_merged) # 64,837 observations and 49 variables
```
...
```{r}
about_data(medstar_aps_merged) # 64,685 observations and 49 variables
```
